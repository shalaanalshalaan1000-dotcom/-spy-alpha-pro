...
#property description "XAUUSD executor with MT5 execution reporting for Gold Alpha Pro"
...
int OnInit()
{
   ...
   ReportHeartbeat();
   Print("GoldAlphaExecutor v2 active on ",g_symbol," (trading: ",EnableTrading,")");
