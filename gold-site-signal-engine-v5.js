...
const BUILD='site-signal-noai-v15-immutable-levels';
...
server.listen(PORT,'0.0.0.0',()=>{console.log(`[gold-site-signal-engine] ${BUILD} listening on ${PORT}; TradingView chart stream ${TV_SYMBOL}; immutable trade levels; no subscription; AI=off; execution=off; telegram-only`);connectTradingView();});
