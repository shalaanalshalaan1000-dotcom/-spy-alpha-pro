...
function patchTargetTracking(source){
  ...
  // The visible gold panel must use the same fresh quote payload as the auto engine.
  // /api/auto-trade/signal always exposes price + updatedAt, matching goldBrowserReading().
