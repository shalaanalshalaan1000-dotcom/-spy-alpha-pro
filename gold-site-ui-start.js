...
function patchSiteSignalUi(source) {
  ...
  source = source.replace(
    ...
    'لا تُعرض صفقة إلا بعد اعتمادها من محرك الموقع ولمس نطاق الدخول؛ ثم تُرسل مباشرة إلى تيليغرام. لا يوجد AI في قرار الإشارة.'
  );
  source = source.replace(
