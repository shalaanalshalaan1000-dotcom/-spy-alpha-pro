...
function patchSiteSignalUi(source) {
  ...
  source = source.replace(
    ...
    '<div class="goldPlanCard"><span>تقدم الإشارة</span><strong id="goldSetupProgress">0%</strong><small id="goldSetupSteps">Structure — • Trend — • Momentum — • Price Action — • Liquidity — • Fib —</small></div><div class="goldPlanCard"><span>الشرط الناقص الآن</span><strong id="goldMissingCondition">—</strong><small>يتحدث مع كل قراءة جديدة</small></div><div class="goldPlanCard"><span>اللوت المحسوب</span><strong id="goldLotSize">—</strong><small id="goldLotRisk">حسب مسافة SL</small></div><div class="goldPlanCard"><span>ICT Origin Setup</span><strong id="goldIctDraw">—</strong><small id="goldIctBias">15m context • 1m/5m execution</small></div><div class="goldPlanCard"><span>Price Action / Reversal</span><strong id="goldPatternRead">—</strong><small id="goldPatternState">Wedge • Triangle • H&S • HH/HL • LH/LL</small></div><div class="goldPlanCard"><span>Technical Confluence</span><strong id="goldTechnicalRead">—</strong><small id="goldTechnicalState">MA50/200 • RSI14 • MACD • Stoch 5,3,3 • Candle</small></div><div class="goldPlanCard"><span>إلغاء السيناريو</span><strong id="goldInvalidation">—</strong><small id="goldModelWindow">بيانات الرصد: —</small></div>'
  );
  source = source.replace(
