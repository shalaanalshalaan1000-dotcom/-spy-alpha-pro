...
const contractIfSave="    if(d.contract){\n      if(Number(d.confidence)>=70&&['CALL','PUT'].includes(d.state))saveSuggestedContract(s,d);\n      const c=d.contract;";
